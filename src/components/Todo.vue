<template>
  <div class="todo">
    ...
    <ul>
      <li v-bind:key="item.message" v-for="item in filteredTodos" draggable="true" v-on:dragstart="dragItem(item,$event)" v-on:dragover.prevent v-on:drop="dropItem(item)">
